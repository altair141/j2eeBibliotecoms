...
DROP TABLE libro;
CREATE TABLE libro (codigoRegistro int NOT NULL, tituloLibro varchar(25) NOT NULL, isbn varchar(25) NOT NULL, autor varchar(15) NOT NULL, editorial varchar(15) NOT NULL, descripcion varchar(150) NOT NULL, idArea int NOT NULL, estado int NOT NULL, agno int, PRIMARY KEY (codigoRegistro), INDEX libro_fk1 (idArea), INDEX libro_estado_fk2 (estado)) ENGINE=InnoDB DEFAULT CHARSET=latin1;
DROP TABLE prestamo;
